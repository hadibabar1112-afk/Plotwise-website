...
const STEPS: StepDef[] = [
  ...
  {
    id: "profileLink", type: "text",
    question: "Drop your main profile link(s)",
    placeholder: "https://instagram.com/yourhandle",
    hint: "Separate multiple links with a comma",
    required: true,
  },
  {
...
export function CreatorForm() {
  ...
  if (!started) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden" style={{ background: T.bg }}>
        ...
        >
          ...
          <h1
            className="font-display text-4xl sm:text-5xl font-normal tracking-tight leading-tight mb-5"
            style={{ color: T.text }}
          >
            Hellooo
          </h1>
          <p className="text-lg leading-relaxed mb-3" style={{ color: T.textMuted }}>
            You're one step away from exclusive access to{" "}
            <span style={{ color: T.deep, fontWeight: 500 }}>high-value brand campaigns.</span>
          </p>
          <p className="text-base leading-relaxed mb-10" style={{ color: T.textFaint }}>
            Answer a few quick questions to get started.
          </p>
          <button
            onClick={() => setStarted(true)}
            className="inline-flex items-center gap-2 rounded-full px-8 h-13 text-base font-medium transition-all duration-200"
            style={{
              background: T.deep,
              color: "#fff",
              height: "52px",
          ...
          <p className="mt-6 text-xs" style={{ color: T.textFaint }}>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      style={{
                        ...
                        boxShadow:
                          canAdvance && !sending
                            ? `0 8px 28px -8px rgba(0,98,92,0.35)`
                            : "none",
                      }}
                      onMouseEnter={(e) => {
                        if (canAdvance && !sending) e.currentTarget.style.background = T.dark;
                      }}
                      onMouseLeave={(e) => {
                        if (canAdvance && !sending) e.currentTarget.style.background = T.deep;
                      }}
                    >
                      {sending ? (
                        <>
          ...
          {STEPS.map((_, i) => (
            <div
              ...
              style={{
                ...
                height: 6,
                background:
                  i === step ? T.deep : i < step ? T.dotDone : T.dotInactive,
              }}
            />
          ))}
        </div>
